        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('foods.index') }}" class="nav-link">Home</a>
                </li>
                ...
                @if (true)
                    <li class="nav-item">
                        <a class="nav-link" href="#" role="button" data-toggle="modal"
                            ...
                            <span class="badge badge-danger navbar-badge" id="cart_item_count">0</span>
                        </a>
                    </li>
                @endif
                        ...
                        <li class="nav-item">
                            <a href="{{ route('orders.ongoing') }}" class="nav-link">
                                ...
                                <p>Hazırlanan Siparişler
                                    <span class="right badge badge-danger">{{ session('order_count') }}</span>
                                </p>
                            </a>
                        </li>
                        <li class="nav-item">
