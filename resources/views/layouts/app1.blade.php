    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">Yemekler</li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="{{ route('orders') }}" class="nav-link">
              ...
              <p>Hazırlanan Siparişler
                <span class="right badge badge-danger">1</span>
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('completedOrders') }}" class="nav-link">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">Yemek <div class="float-right">fiyat&#8378;</div></li>
                  <li class="list-group-item">Yemek <div class="float-right">fiyat&#8378;</div></li>
                  <li class="list-group-item">Yemek <div class="float-right">fiyat&#8378;</div></li>
                  <li class="list-group-item font-weight-bold">Toplam Tutar: <div class="float-right">toplam&#8378;</div></li>
                </ul>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Kapat</button>
                <button type="button" class="btn btn-danger">Sepeti Onayla</button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
